        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Nama, NIK, No HP..." 
                       class="w-full dark:bg-gray-900 bg-white border dark:border-gray-700 border-gray-300 dark:text-gray-100 text-gray-800 px-3 py-2 text-xs rounded-lg focus:border-[#E63946] focus:ring-1 focus:ring-[#E63946] focus:outline-none">
            </div>
                            ...
                            @if($pendukung->ktp_path)
                                ...
                                @if($isPdf)
                                    <button onclick="openPreview('{{ route('pemetaan-dukungan.ktp', $pendukung) }}')"
                                            class="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-[10px] font-semibold dark:bg-gray-800 bg-gray-100 border dark:border-gray-700 border-gray-300 dark:text-gray-300 text-gray-600 hover:bg-[#E63946] dark:hover:bg-[#E63946] hover:text-white hover:border-transparent transition-all">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <form method="POST" action="{{ route('pemetaan-dukungan.destroy', $pendukung) }}"
                                    ...
                                    @csrf @method('DELETE')
                                    <button type="submit"
                                            class="px-3 py-1.5 text-[10px] font-semibold rounded-lg border border-red-500/30 text-red-500 hover:bg-[#E63946] hover:text-white hover:border-transparent transition">
                                        Hapus
                                    </button>
                                </form>
                                @endif
