@php
$inputClass = "w-full dark:bg-gray-900 bg-white border dark:border-gray-700 border-gray-300 dark:text-gray-100 text-gray-800 px-4 py-2.5 text-sm rounded-lg focus:border-[#E63946] focus:ring-1 focus:ring-[#E63946] focus:outline-none transition-all duration-150";
    ...
    <form method="POST" action="{{ route('pemetaan-dukungan.store') }}" enctype="multipart/form-data" 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="file" name="ktp" accept="image/*,application/pdf" class="w-full text-xs dark:text-gray-400 text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-xs file:font-semibold file:bg-[#E63946]/10 file:text-[#E63946] hover:file:bg-[#E63946]/20 file:cursor-pointer">
        ...
        <div class="flex gap-4 pt-4 border-t dark:border-gray-700 border-gray-200">
            ...
            <button type="submit" 
                    class="flex-1 bg-[#E63946] hover:bg-[#BB152C] text-white py-3 rounded-xl text-sm font-bold shadow-lg shadow-red-600/10 transition duration-150">
                Simpan Pendukung →
            </button>
        </div>
    </form>
